...
songs = [
  "Around the World", "Parallel Universe", "Scar Tissue", "Otherside", "Get on Top"  "Californication", "Easily",
  "Porcelain", "Emit Remmus", "I Like Dirt", "This Velvet Glove", "Savior", "Purple Stain", "Right on Time",
  "Road Trippin"
]
songs.each do |song|
